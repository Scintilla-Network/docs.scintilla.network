...
Apart from the usage of a selection of mature core crypto libraries, and implementation of the Cosmos address scheme, Scintilla's functionality has been coded entirely for Scintilla's goals form the ground-up, without forks or SDK usage, to provide a streamlined and optimized codebase to build on without legacy or redundant code, to achieve Scintilla's missiong in a clean and forward-focused way.

# Launch & Distribution

Scintilla launches in 2024 without presale, VC, with a 2.2% initial distribution for airdrop (0.2%) and future community incentives (2%).

Scintilla launch has been informed on Twitter and the Scintilla.network site since February 2024, allowing anyone to learn about Scintilla and join the airdrop via the Discord. 
